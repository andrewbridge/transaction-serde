...
test('options handling', (t) => {
    ...
    t.deepEqual(mergeOptions(DEFAULT_OPTIONS, COMPLETE_OVERRIDE), COMPLETE_OVERRIDE);
    ...
    t.deepEqual(mergeOptions(DEFAULT_OPTIONS, COMPLETE_OVERRIDE, PARTIAL_OVERRIDE), {
        foo: COMPLETE_OVERRIDE.foo,
        bar: PARTIAL_OVERRIDE.bar,
        baz: COMPLETE_OVERRIDE.baz
    });
    t.deepEqual(mergeOptions(DEFAULT_OPTIONS, PARTIAL_OVERRIDE, COMPLETE_OVERRIDE), COMPLETE_OVERRIDE);
});